...
static const u8 sRoamerLocations[][6] =
{
    ...
    { MAP_NUM(MAP_ROUTE118), MAP_NUM(MAP_ROUTE117), MAP_NUM(MAP_ROUTE110), MAP_NUM(MAP_ROUTE111), MAP_NUM(MAP_ROUTE219), MAP_NUM(MAP_ROUTE123) },
    { MAP_NUM(MAP_ROUTE219), MAP_NUM(MAP_ROUTE118), MAP_NUM(MAP_ROUTE120), ___, ___, ___ },
    { MAP_NUM(MAP_ROUTE120), MAP_NUM(MAP_ROUTE219), MAP_NUM(MAP_ROUTE121), ___, ___, ___ },
