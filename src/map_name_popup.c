...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_ROUTE_205_NORTH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_205_SOUTH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_207] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_211_WEST] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_MT_CORONET_NORTH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAKE_VERITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAKEFRONT_VERITY] = MAPPOPUP_THEME_WOOD,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_ROUTE_205_NORTH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_205_SOUTH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_207] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_211_WEST] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_MT_CORONET_NORTH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LAKE_VERITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LAKEFRONT_VERITY] = MAPPOPUP_THEME_BW_DEFAULT,
