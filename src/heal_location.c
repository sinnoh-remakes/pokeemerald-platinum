...
{
    if (IsLastHealLocation(HEAL_LOCATION_TWINLEAF_TOWN_RIVALS_HOUSE)
        || IsLastHealLocation(HEAL_LOCATION_TWINLEAF_TOWN_RIVALS_HOUSE_2F)
        || IsLastHealLocation(HEAL_LOCATION_TWINLEAF_TOWN_PLAYERS_HOUSE)
        || IsLastHealLocation(HEAL_LOCATION_TWINLEAF_TOWN_PLAYERS_HOUSE_2F))
        return TRUE;
