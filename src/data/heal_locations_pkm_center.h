...
static const struct HealLocation sHealLocationsPokemonCenter[NUM_HEAL_LOCATIONS - 1] =
{
    ...
    {
        .mapGroup = MAP_GROUP(MAP_TWINLEAF_TOWN_RIVALS_HOUSE_1F),
        .mapNum = MAP_NUM(MAP_TWINLEAF_TOWN_RIVALS_HOUSE_1F),
        .x = 8,
        .y = 7,
    },
    ...
    {
        .mapGroup = MAP_GROUP(MAP_SANDGEM_TOWN_POKEMON_CENTER_1F),
        .mapNum = MAP_NUM(MAP_SANDGEM_TOWN_POKEMON_CENTER_1F),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
...
// e.g. for SandgemTown_PokemonCenter1F/events.inc the following entry gets generated:
// object_event 1, OBJ_EVENT_GFX_NURSE, 7, 2, 3, MOVEMENT_TYPE_FACE_DOWN, 0, 0, TRAINER_TYPE_NONE, 0, SandgemTown_PokemonCenter_1F_EventScript_Nurse, 0
// In this case the localId is 1.
static const u8 sHealNpcLocalId[NUM_HEAL_LOCATIONS - 1] =
{
    [HEAL_LOCATION_TWINLEAF_TOWN_PLAYERS_HOUSE_2F - 1] = 1,
    [HEAL_LOCATION_TWINLEAF_TOWN_RIVALS_HOUSE_2F - 1] = 1,
    ...
    [HEAL_LOCATION_TWINLEAF_TOWN_PLAYERS_HOUSE - 1] = 1,
    [HEAL_LOCATION_TWINLEAF_TOWN_RIVALS_HOUSE - 1] = 1,
    [HEAL_LOCATION_SANDGEM_TOWN - 1] = 1,
