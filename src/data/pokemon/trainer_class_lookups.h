const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_LUCAS_2] = TRAINER_PIC_LUCAS,
    [FACILITY_CLASS_LUCAS_3] = TRAINER_PIC_LUCAS,
    [FACILITY_CLASS_DAWN] = TRAINER_PIC_DAWN,
    [FACILITY_CLASS_DAWN_2] = TRAINER_PIC_DAWN,
    [FACILITY_CLASS_DAWN_3] = TRAINER_PIC_DAWN,
    [FACILITY_CLASS_BARRY] = TRAINER_PIC_DP_BARRY,
...
const u16 gTrainerPicToTrainerBackPic[] =
{
    ...
    [TRAINER_BACK_PIC_BARRY] = TRAINER_PIC_DP_BARRY,
};
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_LUCAS_2] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_LUCAS_3] = TRAINER_CLASS_RIVAL,
