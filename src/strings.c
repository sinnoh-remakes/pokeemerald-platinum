...
const u8 gText_BirchInTrouble[] = _("Look! These are Poke Balls!\nLet's battle using these!");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [MAIL_POCKET]        = COMPOUND_STRING("MAIL"),
    [BATTLEITEMS_POCKET] = COMPOUND_STRING("BTL. ITEMS"),
