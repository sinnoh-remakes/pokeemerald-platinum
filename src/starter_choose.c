...
static const u8 sTextColors[] = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY, TEXT_COLOR_GREEN, TEXT_COLOR_RED, TEXT_COLOR_BLUE};
...
static void Task_StarterChoose(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, FONT_NORMAL, gText_RowanGiveStarter, 0, 1, 0, NULL);
    PutWindowTilemap(0);
...
static void Task_AskConfirmStarter(u8 taskId)
{
    ...
    StringCopy(gStringVar2, categoryText);
    ...
    StringExpandPlaceholders(gStringVar4, sStarterConfirmStrings[selection]);
