...
{
    [MAPSEC_TWINLEAF_TOWN] = {MAP_GROUP(MAP_TWINLEAF_TOWN), MAP_NUM(MAP_TWINLEAF_TOWN), HEAL_LOCATION_TWINLEAF_TOWN_PLAYERS_HOUSE_2F},
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    case MAPSEC_TWINLEAF_TOWN:
        return (gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_TWINLEAF_TOWN_PLAYERS_HOUSE : HEAL_LOCATION_TWINLEAF_TOWN_RIVALS_HOUSE);
    case MAPSEC_EVER_GRANDE_CITY:
