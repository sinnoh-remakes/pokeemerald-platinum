...
{
    [MAPSEC_TWINLEAF_TOWN] = {MAP_GROUP(MAP_TWINLEAF_TOWN), MAP_NUM(MAP_TWINLEAF_TOWN), HEAL_LOCATION_TWINLEAF_TOWN_PLAYERS_HOUSE},
    [MAPSEC_SANDGEM_TOWN] = {MAP_GROUP(MAP_SANDGEM_TOWN), MAP_NUM(MAP_SANDGEM_TOWN), HEAL_LOCATION_SANDGEM_TOWN},
    [MAPSEC_JUBILIFE_CITY] = {MAP_GROUP(MAP_JUBILIFE_CITY), MAP_NUM(MAP_JUBILIFE_CITY), HEAL_LOCATION_NONE},
    [MAPSEC_OREBURGH_CITY] = {MAP_GROUP(MAP_OREBURGH_CITY), MAP_NUM(MAP_OREBURGH_CITY), HEAL_LOCATION_NONE},
    [MAPSEC_OREBURGH_MINE] = {MAP_GROUP(MAP_OREBURGH_CITY), MAP_NUM(MAP_OREBURGH_CITY), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_ROUTE_207] = {MAP_GROUP(MAP_ROUTE207), MAP_NUM(MAP_ROUTE207), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_219] = {MAP_GROUP(MAP_ROUTE219), MAP_NUM(MAP_ROUTE219), HEAL_LOCATION_NONE},
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_TWINLEAF_TOWN:
        return FlagGet(FLAG_VISITED_TWINLEAF_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SANDGEM_TOWN:
        return FlagGet(FLAG_VISITED_SANDGEM_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JUBILIFE_CITY:
        return FlagGet(FLAG_VISITED_JUBILIFE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_OREBURGH_CITY:
        return FlagGet(FLAG_VISITED_OREBURGH_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
