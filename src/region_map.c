...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_201] = {MAP_GROUP(ROUTE201_WEST), MAP_NUM(ROUTE201_WEST), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_202] = {MAP_GROUP(ROUTE202_SOUTH), MAP_NUM(ROUTE202_SOUTH), HEAL_LOCATION_NONE},
