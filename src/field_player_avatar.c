...
static const u8 sRivalAvatarGfxIds[][GENDER_COUNT] =
{
    ...
    // [PLAYER_AVATAR_STATE_HEALING]    = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
    // [PLAYER_AVATAR_STATE_POKETCH]    = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
    // [PLAYER_AVATAR_STATE_SAVING]     = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
};
