...
int GameClear(void)
{
    ...
    if (gSaveBlock2Ptr->playerGender == MALE)
        SetContinueGameWarpToHealLocation(HEAL_LOCATION_TWINLEAF_TOWN_PLAYERS_HOUSE_2F);
    else
        SetContinueGameWarpToHealLocation(HEAL_LOCATION_TWINLEAF_TOWN_RIVALS_HOUSE_2F);
