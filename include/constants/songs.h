...
#define MUS_DP_TV_BROADCAST               582 // Special Report "Search for the Red Gyarados!" (Part 1)
#define MUS_DP_TWINLEAF_NIGHT             583 // Twinleaf Town (Night)
#define MUS_DP_SANDGEM_NIGHT              584 // Sandgem Town (Night)
#define MUS_DP_FLOAROMA_NIGHT             585 // Floaroma Town (Night)
#define MUS_DP_SOLACEON_NIGHT             586 // Solaceon Town (Night)
#define MUS_DP_ROUTE225_NIGHT             587 // Route 225 (Night)
#define MUS_DP_VALOR_LAKEFRONT_NIGHT      588 // Valor Lakefront (Night)
#define MUS_DP_JUBILIFE_NIGHT             589 // Jubilife City (Night)
#define MUS_DP_CANALAVE_NIGHT             590 // Canalave City (Night)
#define MUS_DP_OREBURGH_NIGHT             591 // Oreburgh City (Night)
#define MUS_DP_ETERNA_NIGHT               592 // Eterna City (Night)
#define MUS_DP_HEARTHOME_NIGHT            593 // Hearthome City (Night)
#define MUS_DP_VEILSTONE_NIGHT            594 // Veilstone City (Night)
#define MUS_DP_SUNYSHORE_NIGHT            595 // Sunyshore City (Night)
#define MUS_DP_SNOWPOINT_NIGHT            596 // Snowpoint City (Night)
#define MUS_DP_POKEMON_LEAGUE_NIGHT       597 // Pokémon League (Night)
#define MUS_DP_FIGHT_AREA_NIGHT           598 // Fight Area (Night)
#define MUS_DP_ROUTE201_NIGHT             599 // Route 201 (Night)
#define MUS_DP_ROUTE203_NIGHT             600 // Route 203 (Night)
#define MUS_DP_ROUTE205_NIGHT             601 // Route 205 (Night)
#define MUS_DP_ROUTE206_NIGHT             602 // Route 206 (Night)
#define MUS_DP_ROUTE209_NIGHT             603 // Route 209 (Night)
#define MUS_DP_ROUTE210_NIGHT             604 // Route 210 (Night)
#define MUS_DP_ROUTE216_NIGHT             605 // Route 216 (Night)
#define MUS_DP_ROUTE228_NIGHT             606 // Route 228 (Night)
#define MUS_DP_UNDERGROUND                607 // The Underground
#define MUS_DP_FLAG_CAPTURED              608 // Captured a Flag Underground!
#define MUS_DP_VICTORY_ROAD               609 // Victory Road
#define MUS_DP_ETERNA_FOREST              610 // Eterna Forest
#define MUS_DP_OLD_CHATEAU                611 // Old Chateau
#define MUS_DP_LAKE_CAVERNS               612 // Lake Caverns
#define MUS_DP_AMITY_SQUARE               613 // Amity Square
#define MUS_DP_GALACTIC_HQ                614 // Team Galactic HQ
#define MUS_DP_GALACTIC_ETERNA_BUILDING   615 // Galactic Eterna Building
#define MUS_DP_GREAT_MARSH                616 // Great Marsh
#define MUS_DP_LAKE                       617 // Lake
#define MUS_DP_MT_CORONET                 618 // Mt. Coronet
#define MUS_DP_SPEAR_PILLAR               619 // Spear Pillar
#define MUS_DP_STARK_MOUNTAIN             620 // Stark Mountain
#define MUS_DP_OREBURGH_GATE              621 // Oreburgh Gate
#define MUS_DP_OREBURGH_MINE              622 // Oreburgh Mine
#define MUS_DP_INSIDE_POKEMON_LEAGUE      623 // Decisive Battle! (Pokémon League)
#define MUS_DP_HALL_OF_FAME_ROOM          624 // Hall of Fame
#define MUS_DP_POKE_CENTER_DAY            625 // Pokémon Center (Day)
#define MUS_DP_POKE_CENTER_NIGHT          626 // Pokémon Center (Night)
#define MUS_DP_GYM                        627 // Pokémon Gym
#define MUS_DP_ROWAN_LAB                  628 // The Pokémon Lab
#define MUS_DP_CONTEST_LOBBY              629 // Contest Hall
#define MUS_DP_POKE_MART                  630 // Poké Mart
#define MUS_DP_GAME_CORNER                631 // Game Corner
#define MUS_DP_B_TOWER                    632 // Battle Tower
#define MUS_DP_TV_STATION                 633 // TV Station
#define MUS_DP_GALACTIC_HQ_BASEMENT       634 // Deep Within Team Galactic HQ
#define MUS_DP_AZURE_FLUTE                635 // Azure Flute
#define MUS_DP_HALL_OF_ORIGIN             636 // Hall of Origin
#define MUS_DP_GTS                        637 // GTS
#define MUS_DP_ENCOUNTER_BOY              638 // Trainers' Eyes Meet (Youngster)
#define MUS_DP_ENCOUNTER_TWINS            639 // Trainers' Eyes Meet (Twins)
#define MUS_DP_ENCOUNTER_INTENSE          640 // Trainers' Eyes Meet (Black Belt)
#define MUS_DP_ENCOUNTER_GALACTIC         641 // Team Galactic Appears!
#define MUS_DP_ENCOUNTER_LADY             642 // Trainers' Eyes Meet (Aroma Lady)
#define MUS_DP_ENCOUNTER_HIKER            643 // Trainers' Eyes Meet (Hiker)
#define MUS_DP_ENCOUNTER_RICH             644 // Trainers' Eyes Meet (PI)
#define MUS_DP_ENCOUNTER_SAILOR           645 // Trainers' Eyes Meet (Sailor)
#define MUS_DP_ENCOUNTER_SUSPICIOUS       646 // Trainers' Eyes Meet (Collector)
#define MUS_DP_ENCOUNTER_ACE_TRAINER      647 // Trainers' Eyes Meet (Ace Trainer)
#define MUS_DP_ENCOUNTER_GIRL             648 // Trainers' Eyes Meet (Lass)
#define MUS_DP_ENCOUNTER_CYCLIST          649 // Trainers' Eyes Meet (Cyclist)
#define MUS_DP_ENCOUNTER_ARTIST           650 // Trainers' Eyes Meet (Artist)
#define MUS_DP_ENCOUNTER_ELITE_FOUR       651 // The Elite Four Appears!
#define MUS_DP_ENCOUNTER_CHAMPION         652 // Champion Cynthia
#define MUS_DP_VS_WILD                    653 // Battle! (Wild Pokémon)
#define MUS_DP_VS_GYM_LEADER              654 // Battle! (Gym Leader)
#define MUS_DP_VS_UXIE_MESPRIT_AZELF      655 // Battle! (Uxie / Mesprit / Azelf)
#define MUS_DP_VS_TRAINER                 656 // Battle! (Trainer Battle)
#define MUS_DP_VS_GALACTIC_BOSS           657 // Battle! (Team Galactic Boss)
#define MUS_DP_VS_DIALGA_PALKIA           658 // Battle! (Dialga / Palkia)
#define MUS_DP_VS_CHAMPION                659 // Battle! (Champion)
#define MUS_DP_VS_GALACTIC                660 // Battle! (Team Galactic)
#define MUS_DP_VS_RIVAL                   661 // Battle! (Rival)
#define MUS_DP_VS_ARCEUS                  662 // Battle! Arceus
#define MUS_DP_VS_LEGEND                  663 // Battle! (Legendary Pokémon)
#define MUS_DP_VICTORY_WILD               664 // Victory! (Wild Pokémon)
#define MUS_DP_VICTORY_TRAINER            665 // Victory! (Trainer Battle)
#define MUS_DP_VICTORY_GYM_LEADER         666 // Victory! (Gym Leader)
#define MUS_DP_VICTORY_CHAMPION           667 // Victory! (Champion)
#define MUS_DP_VICTORY_GALACTIC           668 // Victory! (Team Galactic)
#define MUS_DP_VICTORY_ELITE_FOUR         669 // Victory (Elite Four)
#define MUS_DP_VS_GALACTIC_COMMANDER      670 // Battle! (Team Galactic Commander)
#define MUS_DP_CONTEST                    671 // Super Contest!
#define MUS_DP_VS_ELITE_FOUR              672 // Battle! (Elite Four)
#define MUS_DP_FOLLOW_ME                  673 // Hurry Along
#define MUS_DP_RIVAL                      674 // Rival
#define MUS_DP_LAKE_EVENT                 675 // A Surprise at the Lake!
#define MUS_DP_EVOLUTION                  676 // Evolution
#define MUS_DP_LUCAS                      677 // Lucas
#define MUS_DP_DAWN                       678 // Dawn
#define MUS_DP_LEGEND_APPEARS             679 // The Legendary Pokémon Appears!
#define MUS_DP_CATASTROPHE                680 // Catastrophe!
#define MUS_DP_POKE_RADAR                 681 // A Poké Radar Hit!
#define MUS_DP_SURF                       682 // Surf
#define MUS_DP_CYCLING                    683 // Bicycle
#define MUS_DP_LETS_GO_TOGETHER           684 // Let's Go Together
#define MUS_DP_TV_END                     685 // Special Report "Search for the Red Gyarados!" (Part 2)
#define MUS_DP_LEVEL_UP                   686 // Level Up!
#define MUS_DP_EVOLVED                    687 // Congratulations! Your Pokémon Evolved!
#define MUS_DP_OBTAIN_KEY_ITEM            688 // Obtained a Key Item!
#define MUS_DP_OBTAIN_ITEM                689 // Obtained an Item!
#define MUS_DP_CAUGHT_INTRO               690 // Fanfare: Pokémon Caught (Unused)
#define MUS_DP_DEX_RATING                 691 // Pokédex Evaluation (Unused)
#define MUS_DP_OBTAIN_BADGE               692 // Obtained a Badge!
#define MUS_DP_POKETCH                    693 // Obtained a Pokétch App!
#define MUS_DP_OBTAIN_TMHM                694 // Obtained a TM!
#define MUS_DP_OBTAIN_ACCESSORY           695 // Got an Accessory
#define MUS_DP_MOVE_DELETED               696 // Move Deleted
#define MUS_DP_HEAL                       697 // Pokémon Healed
#define MUS_DP_OBTAIN_BERRY               698 // Obtained a Berry!
#define MUS_DP_CONTEST_DRESS_UP           699 // Contest: Dress Up
#define MUS_DP_HALL_OF_FAME               700 // Congratulations on Entering the Hall of Fame!
#define MUS_DP_INTRO                      701 // Opening Movie (Part 1)
#define MUS_DP_TITLE                      702 // Opening Movie (Part 2)
#define MUS_DP_MYSTERY_GIFT               703 // Mystery Gift
#define MUS_DP_WFC                        704 // Nintendo Wi-Fi Connection
#define MUS_DP_DANCE_EASY                 705 // Dance: Easy
#define MUS_DP_DANCE_DIFFICULT            706 // Dance: Difficult
#define MUS_DP_CONTEST_RESULTS            707 // Contest: Results Announcement
#define MUS_DP_CONTEST_WINNER             708 // Contest: Winner
#define MUS_DP_POFFINS                    709 // Poffins
#define MUS_DP_SLOTS_WIN                  710 // You're a Winner!
#define MUS_DP_SLOTS_JACKPOT              711 // You're a Jackpot Winner!
#define MUS_DP_CREDITS                    712 // Ending Theme
#define MUS_DP_UNUSED                     713 // Unused
#define MUS_DP_UNUSED_2                   714 // Unused
// Platinum Music
#define MUS_PL_FIGHT_AREA_DAY             715 // Fight Area (Battle Frontier)
#define MUS_PL_TV_BROADCAST               716 // Special Program: "Let's Ask Prof. Rowan!" (Part 1)
#define MUS_PL_TV_END                     717 // Special Program: "Let's Ask Prof. Rowan!" (Part 2)
#define MUS_PL_INTRO                      718 // Title Screen
#define MUS_PL_TITLE                      719 // Press Start
#define MUS_PL_DISTORTION_WORLD           720 // Distortion World
#define MUS_PL_B_ARCADE                   721 // Battle Arcade
#define MUS_PL_B_HALL                     722 // Battle Hall
#define MUS_PL_B_CASTLE                   723 // Battle Castle
#define MUS_PL_B_FACTORY                  724 // Battle Factory
#define MUS_PL_GLOBAL_TERMINAL            725 // Global Terminal
#define MUS_PL_LILYCOVE_BOSSA_NOVA        726 // Villa Audio System: Bossa Nova Lilycove
#define MUS_PL_LOOKER                     727 // Looker's Theme
#define MUS_PL_VS_GIRATINA                728 // Battle! (Giratina)
#define MUS_PL_VS_FRONTIER_BRAIN          729 // Battle! (Frontier Brain)
#define MUS_PL_VICTORY_FRONTIER_BRAIN     730 // Victory! (Frontier Brain)
#define MUS_PL_VS_REGI                    731 // Battle! (Regirock / Regice / Registeel / Regigigas)
#define MUS_PL_CONTEST_COOL               732 // Super Contest: Coolness
#define MUS_PL_CONTEST_SMART              733 // Super Contest: Smartness
#define MUS_PL_CONTEST_CUTE               734 // Super Contest: Cuteness
#define MUS_PL_CONTEST_TOUGH              735 // Super Contest: Toughness
#define MUS_PL_CONTEST_BEAUTY             736 // Super Contest: Beauty
#define MUS_PL_SPIN_TRADE                 737 // Spin Trade
#define MUS_PL_WIFI_MINIGAMES             738 // Wi-Fi Plaza: Mini-Games
#define MUS_PL_WIFI_PLAZA                 739 // Wi-Fi Plaza
#define MUS_PL_WIFI_PARADE                740 // Wi-Fi Plaza: Parade
#define MUS_PL_GIRATINA_APPEARS_1         741 // Giratina Appears!
#define MUS_PL_GIRATINA_APPEARS_2         742 // Giratina Appears! Part 2
#define MUS_PL_MYSTERY_GIFT               743 // Mystery Gift
#define MUS_PL_TWINLEAF_MUSIC_BOX         744 // Villa Music Box: Twinleaf Tune
#define MUS_PL_OBTAIN_ARCADE_POINTS       745 // Received BP in the Battle Arcade!
