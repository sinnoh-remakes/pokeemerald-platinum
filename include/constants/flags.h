...
#define FLAG_REGISTERED_DALLAS               (TRAINER_REGISTERED_FLAGS_START + REMATCH_DALLAS)
#define FLAG_REGISTERED_MADELINE_PT          (TRAINER_REGISTERED_FLAGS_START + REMATCH_MADELINE_PT)
