...
porytiles compile-secondary -tiles-primary-override=384 -Wall -o ./data/tilesets/secondary/eterna ./tiles/eterna ./tiles/outdoor_eterna ./include/constants/metatile_behaviors.h
