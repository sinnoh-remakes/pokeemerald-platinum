...
porytiles compile-secondary -Wall -o ./data/tilesets/secondary/route_205_north ./tiles/route_205_north ./tiles/outdoor_route_205 ./include/constants/metatile_behaviors.h
